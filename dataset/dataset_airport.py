...
cla = CLA
classes = ['overpass','solar_panel','runway','parking_space','freeway']
#classes = ['solar_panel']
for cla in classes:
    rootDir = PATH + cla + '/'
    ...
    #    jix = np.reshape(jix,[256,1])
        ...
        ji_out[:,0] = jix_r
        ji_out[:,1] = jiy_r
        ji_out_real = np.zeros([296,2])       
        ji_out_real[:,0] = jix
        ji_out_real[:,1] = jiy
        ji = [ji_out,ji_out_real,cla]
