...
#for cla in classes:
#train_cla =['solar_panel', 'wastewater_treatment_plant', 'freeway', 'parking_space', 'runway', 'bridge', 'storage_tank', 'dense_residential', 'crosswalk', 'overpass'] 
train_cla = ['runway']
for cla in classes:
    if cla in train_cla:
        rootDir = 'images/' + cla + '/'
        ...
        for i in range(400, len(image_list)):  # all the images
